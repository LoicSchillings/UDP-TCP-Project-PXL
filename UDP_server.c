...
void execution( int internet_socket )
{
	...
	//Step 2.2 Send first set of random integers
	srand(time(0));
    ...
    number_of_bytes_send = sendto( internet_socket, chartosend, 16, 0, (struct sockaddr *) &client_internet_address, client_internet_address_length );
	...
	//Step 2.3 Receive first highest integer
	...
	{
		buffer[number_of_bytes_received] = '\0';
		printf( "Received 1st highest integer: %s\n", buffer );
	}
	...
	//Step 2.5 Receive second highest integer
	number_of_bytes_received = 0;
	number_of_bytes_received = recvfrom( internet_socket, buffer, ( sizeof buffer ) - 1, 0, (struct sockaddr *) &client_internet_address, &client_internet_address_length );
	if( number_of_bytes_received == -1 )
	{
	...
	{
		buffer[number_of_bytes_received] = '\0';
		printf( "Received 2nd highest integer: %s\n", buffer );
	}
	
	//Step 2.6 Send OK to acknowledge received last integer
	int number_of_bytes_send = 0;
